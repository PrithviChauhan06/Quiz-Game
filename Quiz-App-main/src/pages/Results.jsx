    ...
    <div className="page">
      <div className="glass-card">
        ...
        <footer className="footer-bar">
          ...
          <button onClick={() => navigate(0)} className="btn btn-outline">Try Again</button>
          <button onClick={() => navigate('/review', { state })} className="btn btn-primary">Review Answers</button>
        </footer>
      </div>
    </div>
  );
